\ProvidesFile{abstract.tex}[Краткий Конспект]
\newpage
...
\end{theorem}
\begin{proof}
  \[\rho_{\text{сф}}(z_1,z_2)^2 = \left(\frac{x_1}{1+|z_1|^2} - \frac{x_2}{1+|z_2|^2}\right)^2 + \left(\frac{y_1}{1+|z_1|^2} - \frac{y_2}{1+|z_2|^2}\right)^2 + \left(\frac{|z_1|^2}{1+|z_1|^2} - \frac{|z_2|^2}{1+|z_2|^2}\right)^2=\]
  \[=\left(\frac{x_1(1+|z_2|^2) - x_2(1+|z_1|^2)}{(1+|z_1|^2)(1+|z_2|^2)}\right)^2+\left(\frac{y_1(1+|z_2|^2) - y_2(1+|z_1|^2)}{(1+|z_1|^2)(1+|z_2|^2)}\right)^2+\left(\frac{|z_1|^2(1+|z_2|^2) - |z_2|^2(1+|z_1|^2)}{(1+|z_1|^2)(1+|z_2|^2)}\right)^2=\]
  \[=\frac{x_1^2(1+|z_2|^2)^2 - 2x_1x_2(1+|z_2|^2)(1+|z_1|^2) + x_2^2(1+|z_1|^2)^2}{(1+|z_1|^2)^2(1+|z_2|^2)^2} + \]
  \[+\frac{y_1^2(1+|z_2|^2)^2 - 2y_1y_2(1+|z_2|^2)(1+|z_1|^2) + y_2^2(1+|z_1|^2)^2}{(1+|z_1|^2)^2(1+|z_2|^2)^2}+\]
  \[+\frac{|z_1|^4(1+|z_2|^2)^2 - 2|z_1|^2|z_2|^2(1+|z_2|^2)(1+|z_1|^2) + |z_2|^4(1+|z_1|^2)^2}{(1+|z_1|^2)^2(1+|z_2|^2)^2}=\]
  \[=\frac{|z_1|^2+|z_1|^4}{(1+|z_1|^2)^2} + \frac{|z_2|^2+|z_2|^4}{(1+|z_2|^2)^2} - \frac{2|z_1|^2|z_2|^2 + 2x_1x_2 + 2y_1y_2}{(1+|z_1|^2)(1+|z_2|^2)}=\]
  \[=\frac{|z_1|^2(1+|z_2|^2) +|z_2|^2(1+|z_1|^2)- 2|z_1|^2|z_2|^2 - 2x_1x_2 - 2y_1y_2}{(1+|z_1|^2)(1+|z_2|^2)}=\]
  \[=\frac{|z_1|^2+|z_2|^2 - 2x_1x_2 - 2y_1y_2}{(1+|z_1|^2)(1+|z_2|^2)}=\frac{x_1^2+y_1^2+x_2^2+y_2^2 - 2x_1x_2 - 2y_1y_2}{(1+|z_1|^2)(1+|z_2|^2)}=\]
  \[=\frac{(x_1-x_2)^2+(y_1-y_2)^2}{(1+|z_1|^2)(1+|z_2|^2)} = \frac{\rho(z_1,z_2)^2}{(1+|z_1|^2)(1+|z_2|^2)}\]
  Значит:
  \[\rho_{\text{сф}}(z_1,z_2) = \frac{\rho(z_1,z_2)}{\sqrt{1+|z_1|^2}\sqrt{1+|z_2|^2}}\]
  Найдём формулу расстояния до бесконечности:
  \[\rho_{\text{сф}}(z,\infty) = \rho(Z, N) =  \left(\frac{x}{1+|z|^2} - 0\right)^2 + \left(\frac{y}{1+|z|^2} - 0\right)^2 + \left(\frac{|z|^2}{1+|z|^2} - 1\right)^2=\]
     \[=\frac{x^2+y^2+1}{(1+|z|^2)^2}=\frac{|z|^2+1}{(1+|z|^2)^2} = \frac{1}{1+|z|^2}\]
  Теперь рассмотрим разные случаи сходимости:
  \begin{enumerate}
    \item $z_n\to z\in\C\implies \exists N\in\N\colon \forall n > N\q|z_n|<R$
    \[\rho_{\text{сф}}(z_n,z) = \frac{|z_n-z|}{\sqrt{1+|z_n|^2}\sqrt{1+|z|^2}}\leqslant |z_n-z|\to 0\]
    \item $\rho_{\text{сф}}(z_n,z)\to 0,\q z\in\C\implies \exists R > 0,\q N\in\N\colon\forall n > N\q \zeta_n,\zeta < \frac{R^2}{1+R^2}$, где $Z_n=(\xi_n,\eta_n,\zeta_n),\q Z=(\xi,\eta,\zeta)$ - проекции $z_n$ и $z$, т.е. мы отделились от полюса сферы Римана по $\zeta$ координате. Тогда
      \[|z_n|^2 = x^2 + y^2 = \frac{\xi_n^2+\eta_n^2}{(1-\zeta_n)^2}= \frac{\frac{1}{4}-(\zeta_n-\frac{1}{2})^2}{(1-\zeta_n)^2}=\frac{\zeta_n - \zeta_n^2}{(1-\zeta_n)^2}=\]\[=\frac{\zeta_n}{1-\zeta_n}<\frac{\frac{R^2}{1+R^2}}{\frac{1}{1+R^2}} = R^2\implies |z_n|<R\implies \sqrt{1+|z_n|^2}<\sqrt{1+R^2}\]
      Аналогично для $|z|$. Итого получаем, что
      \[0\leqslant \frac{|z_n-z|}{1+R^2}\leqslant \frac{|z_n-z|}{\sqrt{1+|z_n|^2}\sqrt{1+|z|^2}}\to 0\]
      \[\implies |z_n-z|\to 0\lra z_n\to z\]
    \item $z_n\to \infty\implies |z_n|\to \infty\implies \rho_{\text{сф}}(z_n,\infty) = \frac{1}{1+|z_n|^2}\to 0$ 
    \item $\rho_{\text{сф}}(z_n,\infty)\to 0\implies 1+|z_n|^2\to \infty\implies z_n\to \infty$
  \end{enumerate}
\end{proof}
\subsection{$\C$-дифференцируемость функции комплексной переменной}
\[f(z)=u(z)+iv(z)\sim u(x,y)+iv(x,y)\]
\begin{definition}
  Функция $f\colon U(z_0)\to\C$ $\R$-дифференцируема в т. $z_0$, если $u :=\Rea f,\q v:=\Ima f$ $\R$-дифференцируемы в т. $(x_0,y_0)$, т.е.
  \[u(x,y) - u(x_0,y_0) = u'_x(x_0,y_0)\Delta x + u'_y(x_0,y_0)\Delta y + \overline{o}(|\Delta z|)\]
  \[v(x,y) - v(x_0,y_0) = v'_x(x_0,y_0)\Delta x + v'_y(x_0,y_0)\Delta y + \overline{o}(|\Delta z|)\]
  \[\implies f(z) - f(z_0) = \begin{pmatrix}u'_x(x_0,y_0)&u'_y(x_0,y_0)\\v'_x(x_0,y_0)&v'_y(x_0,y_0)\end{pmatrix}\begin{pmatrix}\Delta x\\\Delta y\end{pmatrix} + \overline{o}(\Delta z),\q \Delta z\to 0\]
    Перейдём от матриц к числам через добавление $i$:
    \[\implies f(z) - f(z_0)= (u'_x+iv'_x)\Delta x + (u'_y + iv_y)\Delta y + \overline{o}(\Delta z)=\]
    \[=(u'_x+iv'_x)\Delta x + (-iu'_y + v_y)i\Delta y + \overline{o}(\Delta z)=\]
    \[=(u'_x+iv'_x)\Delta x + \frac{1}{2}(-iu'_y + v_y)\Delta x + \frac{1}{2}(iu'_y - v_y)\Delta x + \]\[+(-iu'_y + v_y)i\Delta y + \frac{1}{2}(u'_x+iv'_x)i\Delta y - \frac{1}{2}(u'_x+iv'_x)i\Delta y+\overline{o}(\Delta z)=\]
    \[=\frac{u'_x+iv'_x - iu'_y + v'_y}{2}\Delta x + \frac{u'_x+iv'_x + iu'_y - v'_y}{2}\Delta x+\]
    \[+\frac{u'_x+iv'_x - iu'_y + v'_y}{2}i\Delta y - \frac{u'_x+iv'_x + iu'_y - v'_y}{2}i\Delta y + \overline{o}(\Delta z)=\]
    \[=\frac{u'_x+iv'_x - iu'_y + v'_y}{2}\Delta z + \frac{u'_x+iv'_x + iu'_y - v'_y}{2}\overline{\Delta z} + \overline{o}(\Delta z)=:\]
    \[=:\p{f}{z}(z_0)\Delta z+\p{f}{\overline{z}}(z_0)\overline{\Delta z} + \overline{o}(\Delta z)\]
    где $\p{f}{z}(z_0),\q \p{f}{\overline{z}}(z_0)$ - формальные производные. 
\end{definition}
\begin{definition}
...
\begin{proof}
 ...
 \end{enumerate} 
\end{proof}
\subsection{Пути и кривые}
\begin{definition}
  Путём называется отображение $\g \colon [0,1]\to\C\colon \g\in C([0,1])$
\end{definition}
\begin{definition}
  $\g(0)=\g(1)$ - замкнутый путь. 
\end{definition}
\begin{definition}
  Путь называется гладким, если $\g\in C^1([0,1])$ и $\g'(t)\neq 0$ 
\end{definition}
\begin{definition}
  Незамкнутый путь называется простым(Жордановым), если $\g$ - инъекция. 
\end{definition}
\begin{definition}
  $\g([0,1])=:\gamma$ называется простой кривой, где $\g$ - простой путь. $\g$ называют параметризацией кривой $\gamma$. 
\end{definition}
\begin{definition}
  Кривая $\gamma$ называется гладкой, если её параметризация $\g$ гладкая. 
\end{definition}
\begin{definition}
  Множество $M$ называется линейно связным, если $\forall z_1,z_2\in M\q\exists$ путь $\g\colon\g(0)=z_1,\q\g(1)=z_2$ и $\forall t\in[0,1]\q \g(t)\in M$.
\end{definition}
\begin{definition}
  Множество $D$ называется областью, если оно открыто и линейно связно. 
\end{definition}
  Границу $D$ будем обозначать $\partial D$. Положительным обходом $D$ будем считать такой, при котором область $D$ будет слева.
...
\begin{definition}
  $f$ голоморфна в области $D\subseteq \overline{\C}$, если она голоморфна в каждой её точке. Обозначение:$f\in\O(D)$
\end{definition}
\begin{theorem}
  $D$ - односвязная область. $u$ - гармоническая функция в $D$. Тогда $\exists!$ (с точностью до мнимой константы) $f\in \O(D)\colon \Rea f=u$ 
\end{theorem}
...
\begin{proof}
  ...
  \[(f(\g(t)))' = \begin{pmatrix}u'_x&u'_y\\v'_x&v'_y\end{pmatrix}\begin{pmatrix}x'(t)\\y'(t)\end{pmatrix}\]
    где $\begin{pmatrix}x'(t)\\y'(t)\end{pmatrix}\neq 0$, т.к. $f(\g_i)$ гладкие, и $\begin{pmatrix}u'_x&u'_y\\v'_x&v'_y\end{pmatrix} = \begin{pmatrix}a&-b\\b&a\end{pmatrix}$, т.к. $f$ конформна. 
        \[0\neq |f'(z_0)| = \sqrt{a^2+b^2}\implies \det \begin{pmatrix}a&-b\\b&a\end{pmatrix}=a^2+b^2\neq 0\implies \text{ нет решений }\]
    А значит $f(\g_i(t))$ - гладкие пути. Вынесем $\sqrt{a^2+b^2}$ из матрицы и получим:
...
\end{definition}
\begin{definition}
  Отображение $w=\begin{cases}
    \frac{1}{z},\q z\neq 0,\q \infty\\
    \infty,\q z=0\\
    0,\q z=\infty
  \end{cases}$ называется инверсией. 
\end{definition}
Свойства ДЛО:
\begin{enumerate}
  \item ДЛО - гомеоморфизм $\RC\to\RC$
  \item ДЛО конформно в $\RC$
  \item ДЛО образует группу относительно операции композиции
  \item ДЛО - композиция сдвига, поворота, растяжения и инверсии
\end{enumerate}
\begin{definition}
  Обобщённой окружностью на $\RC$ называется окружность или прямая. 
\end{definition}
\begin{theorem}[(Круговое свойство ДЛО)]
...
\end{proof}
\begin{definition}
  Точки $z$ и $z^*$ симметричны относительно окружности $|z-z_0|=R$, если они лежат на одном луче с началом в $z_0$ и $|z-z_0||z^*-z_0|=R^2$. При этом $z_0$ симметрична $\infty$. 
\end{definition}
\begin{theorem}
  Пусть $\g$ - обобщённая окружность, задаваемая уравнением $Az\overline{z} + Bz+\overline{B}\overline{z}+C=0,\q A,C\in\R$. Тогда $z_1,\q z_2$ симметричны относительно $\g$ $\lra$ $Az_1\overline{z_2} + Bz_1+\overline{B}\overline{z_2}+C=0$ 
\end{theorem}
\begin{theorem}
...
\end{theorem}
\begin{theorem}[(Правило $3^{\hspace{0.05cm}\underline{x}}$ точек)]
...
\end{proof}
\subsection{Интеграл вдоль пути}
\begin{definition}
...
\begin{enumerate}
  ...
  \begin{proof}
    Пусть $\g$ - параметризация $\gamma^+$, $\tilde{\g}$ - параметризация $\gamma^-$. Тогда $\g(t)=\tilde{\g}(1-t)$ и 
    \[\int_{\gamma^-}f(z)\d z = \int_{0}^{1}f(\tilde{\g}(t))\tilde{\g}(t)'\d t=\int_{0}^{1}f(\g(1-t))(-1)\g(1-t)'\d t = |s:=1-t|=\]
    \[=-\int_{1}^{0}f(\g(s))\g(s)'-\d s = -\int_{0}^{1}f(\g(s))\g(s)'\d s= - \int_{\gamma^+}f(z)\d z\]
  \end{proof}
...
\end{definition}
\begin{theorem}
  Если $F_1,F_2$ - первообразные $f$ в $D$, то $F_1 = F_2 + c$. 
\end{theorem}
\begin{theorem}
...
\end{proof}
\textbf{Следствие:} $f\in\O(D)$, $D$ - круг. Тогда $\exists F$ - первообразная $f$ в $D$. 
\begin{definition}
  ...
  \end{enumerate}
\end{definition}
\textbf{Замечание:} Если у $f$ $\exists$ первообразная $F$ в $D$, то $\Phi(t):=F(\g(t))$ - первообразная вдоль пути. 
\begin{theorem}
...
\begin{proof}
    ...
    \end{enumerate}
\end{proof}
\textbf{Следствие:} Если у $f\in\O(D)$ есть первообразная в $D$, то $\forall \g$- замкнутого пути $\oint\limits_{\g}f(z)\d z=0$ 
...
\end{definition}
\begin{theorem}[(Теорема о гомотопии)]
...
\begin{proof}
  ...
  \end{enumerate}
\end{proof}
\textbf{Следствие:} Если замкнутый путь $\g$ гомотопен 0 в $D$ и $f\in\O(D)$, то $\oint\limits_{\g}f(z)\d z=0$ 
\begin{definition}
  Область $D$ односвязна, если в $D$ любой замкнутый путь гомотопен 0. 
\end{definition}
...
\end{proof}
\begin{theorem}[(О существовании первообразной в односвязной области)]
...
\end{proof}
\textbf{Следствие:} Если $f\in\O(D)$ и $\oint\limits_{\g}f(z)\d z = 0$ $\forall\g$ - замкнутого пути, то $\exists F$ - первообразная $f$ в $D$. 
\begin{proof}
  Аналогично предыдущему, только независимость от выбора пути следует не из ИТК, а из дано.
\end{proof}
\begin{theorem}[(ИТК для многосвязной области)]
...
\begin{definition}
  $f_n(z)\colon\C\to\C$ сходится равномерно на компакте $K$ к функции $f(z)$, если $\Sup{z\in K}|f_n(z)-f(z)|\to 0$. 
\end{definition}
\begin{theorem}
  Пусть на $K$ $|f_n(z)|\leqslant c_n$ и $\Sum{n=1}{\infty}c_n$ сходится. Тогда ряд $\Sum{n=1}{\infty}f_n(z)$ сходится абсолютно и равномерно на $K$. 
\end{theorem}
\begin{theorem}
  $f_n\overset{K}{\rightrightarrows}f$ и $f_n\in C(K)$. Тогда и $f\in C(K)$. 
\end{theorem}
\begin{theorem}
...
\end{proof}
\begin{theorem}[(Неравенство Коши для коэффициентов Тейлора)]
...
\begin{definition}
  Степенные ряды - это ряды вида $\Sum{n=0}{+\infty}b_n(z-a)^n$
\end{definition}
...
\end{proof}
\begin{theorem}[(ИФК для производных голоморфной функции)]
...
\end{proof}
\begin{theorem}[(3 эквивалентных определения голоморфности)]
  ...
  \end{enumerate}
\end{theorem}
\begin{theorem}[(О представлении голоморфной функции в окрестности нуля)]
...
\begin{proof}
  ...
  \end{enumerate}
\end{proof}
\begin{theorem}[(Об изолированности нулей голоморфной функции)]
...
\end{definition}
\begin{theorem}[(Единственности для голоморфных функций)]
